...
# Need this to account for graph output size on rendering
theme_update(plot.tag.position = c(0.05, 1),
          plot.tag = element_text(margin = margin(t = 0.1, b = 0.1, unit = "inch")),
          plot.title = element_text(margin = margin(t = 0.15, b = 0.05, unit = "inch")))
```
