...
theme_set(theme_classic() + 
            theme(plot.title = element_text(size = 18,
                                face = "bold",
                                hjust = 0.5,
                                margin = margin(t = 0.15, b = 0.05, unit = "inch")),
      plot.subtitle = element_text(size = 10, 
                                   color = "grey50",
                                   face = "bold",
                                   hjust = 0.5,
                                   margin = margin(b = 0.2, unit = "inch")),
      plot.tag = element_text(face = "bold",
                              margin = margin(t = 0.1, b = 0.1, unit = "inch")),
      plot.caption = element_text(hjust = 0,
                                  face = 'italic'),
      axis.title.x = element_text(size = 16,
                                  face = "bold",
                                  margin = margin(t = 0.2, unit = "inch")),
      axis.title.y = element_text(size = 16,
                                  face = "bold",
                                  margin = margin(r = 0.2, unit = "inch")),
...
```{r fig.align='center', out.width="376.5px", out.height="400px", echo = FALSE}
knitr::include_graphics("figures/hue.png")
```
...
(data.frame(x = c("a", "b", "c", "d", "e"), y = c(5, 5, 5, 5, 5)) %>%
ggplot(., aes(x, y, fill = x)) + 
  ...
  theme(legend.position = "none",
        axis.line = element_line(color = "white"))) + (data.frame(x = c("a", "b", "c", "d", "e"), y = c(5, 5, 5, 5, 5)) %>%
ggplot(., aes(x, y, fill = x)) + 
  geom_bar(stat = "identity",
           position = "identity",
           width = 1) + 
...
```{r echo = FALSE}
((plot_hex +
    scale_fill_distiller(palette = "GnBu")) + (plot_line +
  scale_color_distiller(palette = "RdPu"))) / ((plot_jitter +
  scale_color_brewer(palette = "Dark2")) + (plot_bar +
  scale_fill_brewer(palette = "Set2")))
```
...
((plot_jitter + 
  scale_color_grey() + 
    ggtitle("Default")) + (plot_bar + 
  scale_fill_grey()+ 
    ggtitle("Default"))) / ((plot_bar + 
  scale_fill_grey(start = 0, end = 0.5)+ 
    ggtitle("Range 0-0.5")) + (plot_bar + 
  scale_fill_grey(start = 0.5, end = 0.95)+ 
    ggtitle("Range 0.5-0.95")))
```
...
```{r echo = FALSE}
((plot_bar + 
  scale_fill_viridis(discrete = TRUE)) + (plot_jitter + 
  scale_color_viridis(discrete = TRUE, option = "plasma"))) / ((plot_line + 
  scale_color_viridis(option = "inferno")) + (plot_hex + 
  scale_fill_viridis()))
```
...
```{r echo = FALSE}
 (plot_bar +
    scale_fill_manual(values = sequential_hcl(n = 3, 
                                              palette = "BuGn",
                                              c = 400)) +
      ggtitle("Change Chrominance")) / (plot_bar +
    scale_fill_manual(values = sequential_hcl(n = 3, palette = "BuGn"))+
   ggtitle("Original")) / (plot_bar +
    scale_fill_manual(values = sequential_hcl(n = 3, 
                                              palette = "BuGn",
                                              l = c(10,40))) +
      ggtitle("Change Luminance"))
```
</div>
